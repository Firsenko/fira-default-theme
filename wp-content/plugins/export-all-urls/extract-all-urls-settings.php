...
function eau_generate_html()
{
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label><input type="radio" name="post-type" value="any" required="required"/> All
            ...
            <div id="eauSideContainer" class="eaucolumns">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <strong>Reporting</strong> an issue is way better than leaving <strong>1 star</strong> feedback, which does not help you, me, or the community. So, please consider giving me a chance to help before leaving negative feedback.
                        <hr>
    ...
    if (isset($_POST['export'])) {
        ...
        if (!empty($_POST['post-type']) && !empty($_POST['export-type']) && !empty($_POST['additional-data']) && !empty($_POST['post-status']) && !empty($_POST['post-author']) && !empty($_POST['number-of-posts'])) {
            ...
            eau_generate_output($selected_post_type, $post_status, $post_author, $exclude_domain, $post_per_page, $offset, $export_type, $additional_data, $csv_path, $csv_name, $posts_from, $posts_upto);
